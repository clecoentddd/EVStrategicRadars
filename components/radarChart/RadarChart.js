...
const RadarChart = ({ items, radius, onEditClick, onCreateClick }) => {
    ...
    const renderItems = (g, groupedItems, radius) => {
    ...
    const renderSingleItem = (g, item, position) => {
        const { x, y } = position;
